...
# Mistral rabbit only works when it has the same username as we did for trove rabbitmq
...
#ini_set "$file" keystone_authtoken auth_url ${mistral_public_url}
##ini_set "$file" keystone_authtoken project_name ${mistral_tenant}
#ini_set "$file" keystone_authtoken user-name ${mistral_user}
#ini_set "$file" keystone_authtoken password ${mistral_password}
