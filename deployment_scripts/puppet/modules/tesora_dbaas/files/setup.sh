...
keystone_unversioned_internal_url=$(echo ${keystone_internal_url} | sed 's/\(http[s]*:\/\/[0-9\.]*:[0-9]*\).*/\1/' )
...
ini_set "$file" keystone_authtoken auth_uri ${keystone_unversioned_internal_url}
